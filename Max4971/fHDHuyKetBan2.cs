...
public class fHDHuyKetBan2 : Form
{
	...
	public fHDHuyKetBan2(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDHuyKetBanNhanh").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDHuyKetBanNhanh', 'Hủy kết bạn nhanh');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDHuyKetBanNhanh");
	...
	private void fHDHuyKetBan2_Load(object sender, EventArgs e)
	{
		try
		{
	...
	private void InitializeComponent()
	{
		...
		base.Name = "fHDHuyKetBan2";
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "Cấu hình tương tác";
		base.Load += new System.EventHandler(fHDHuyKetBan2_Load);
