...
public class fHDKetBanTepUidv2 : Form
{
	...
	public fHDKetBanTepUidv2(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDKetBanTepUidv2").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanTepUidv2', 'Kết bạn theo tệp Uid v2');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDKetBanTepUidv2");
	...
	private void fHDKetBanTepUidv2_Load(object sender, EventArgs e)
	{
		try
		{
			...
			ckbTuDongXoaUid.Checked = gclass17_0.method_3("ckbKetBanTrungNhau");
			...
			nudTuongTacDelayFrom.Value = gclass17_0.method_2("nudTuongTacDelayFrom", 3);
			nudTuongTacDelayTo.Value = gclass17_0.method_2("nudTuongTacDelayTo", 5);
	...
	private void InitializeComponent()
	{
		...
		this.bunifuCustomLabel1.Size = new System.Drawing.Size(341, 31);
		...
		this.pnlHeader.Size = new System.Drawing.Size(341, 31);
		...
		this.panel1.Size = new System.Drawing.Size(344, 406);
		...
		this.plTuongTacComment.Controls.Add(this.label9);
		...
		this.btnCancel.Location = new System.Drawing.Point(184, 364);
		...
		this.btnAdd.Location = new System.Drawing.Point(77, 364);
		...
		this.bunifuCards1.Size = new System.Drawing.Size(341, 37);
		...
		base.Load += new System.EventHandler(fHDKetBanTepUidv2_Load);
