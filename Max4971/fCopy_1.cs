...
public class fCopy_1 : Form
{
	...
	public fCopy_1(List<string> list_2)
	{
		InitializeComponent();
		list_1 = list_2;
		method_0();
		list_0 = new List<ComboBox> { cbbDinhDang1, cbbDinhDang2, cbbDinhDang3, cbbDinhDang4, cbbDinhDang5, cbbDinhDang6, cbbDinhDang7, cbbDinhDang8, cbbDinhDang9, cbbDinhDang10 };
	}
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		try
		{
			...
			Clipboard.SetDataObject(data, copy: true, 10, 100);
	...
	private void fCopy_1_Load(object sender, EventArgs e)
	{
		method_2();
	}
	...
	private void InitializeComponent()
	{
		...
		this.bunifuCustomLabel1.Size = new System.Drawing.Size(1122, 32);
		...
		this.cbbDinhDang1.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang2.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang3.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang4.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang5.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang6.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang7.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang9.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang8.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.cbbDinhDang10.Items.AddRange(new object[18]
		{
			"Uid", "Pass", "Token", "Cookie", "Email", "Pass Email", "2FA", "Useragent", "Proxy", "Tên",
			"Giới tính", "Theo dõi", "Bạn bè", "Nhóm", "Ngày sinh", "Ngày tạo", "Ghi chú", "MailKp"
		});
		...
		this.Text = "fAddFile";
		base.Load += new System.EventHandler(fCopy_1_Load);
