...
public class fHDBuffViewVideo : Form
{
	...
	public fHDBuffViewVideo(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDBuffViewVideo").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDBuffViewVideo', 'Buff View Video');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDBuffViewVideo");
	...
	private void fHDBuffViewVideo_Load(object sender, EventArgs e)
	{
		try
		{
			nudTimeFrom.Value = gclass17_0.method_2("nudTimeFrom", 30);
	...
	private void txtUid_TextChanged(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtUid.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			label2.Text = string.Format(GClass29.smethod_0("Nhập danh sách ID Video ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		this.nudTimeTo.Location = new System.Drawing.Point(231, 78);
		...
		this.nudTimeFrom.Location = new System.Drawing.Point(134, 78);
		...
		base.Load += new System.EventHandler(fHDBuffViewVideo_Load);
