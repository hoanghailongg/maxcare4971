...
public class fHDThamGiaNhomTuKhoav2 : Form
{
	...
	public fHDThamGiaNhomTuKhoav2(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDThamGiaNhomTuKhoav2").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDThamGiaNhomTuKhoav2', 'Tham gia nhóm theo từ khóa v2');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDThamGiaNhomTuKhoav2");
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		if (list_.Count == 0)
		{
			GClass38.smethod_0(GClass29.smethod_0("Vui lo\u0300ng nhâ\u0323p danh sách từ khóa!"), 3);
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		base.Load += new System.EventHandler(fHDThamGiaNhomTuKhoav2_Load);
