...
public class fHDKhangSpam : Form
{
	...
	public fHDKhangSpam(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDKhangSpam").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKhangSpam', 'Kháng spam');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDKhangSpam");
	...
	private void InitializeComponent()
	{
		...
		this.bunifuCustomLabel1.Text = "Cấu hình Kháng spam";
