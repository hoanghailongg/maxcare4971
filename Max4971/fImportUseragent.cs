...
public class fImportUseragent : Form
{
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		try
		{
			...
			for (int k = 0; k < fChange.fChange_0.dtgvAcc.Rows.Count; k++)
			{
				if (Convert.ToBoolean(fChange.fChange_0.method_26(k, "cChose")) && (!(fChange.fChange_0.method_26(k, "cUseragent") != "") || !ckbKhongNhapTaiKhoanDaCo.Checked))
				{
					if (queue.Count == 0)
					{
						break;
					...
					fChange.fChange_0.method_27(k, "cUseragent", object_);
				}
			}
