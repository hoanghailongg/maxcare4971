...
public class fClearBackup : Form
{
		...
		internal void method_0()
		{
			try
			{
				...
				while (num < fClearBackup_0.list_0.Count)
				{
					if (int_0 < int_1)
					{
						Class56 CS_0024_003C_003E8__locals0 = new Class56
						{
							class55_0 = this
						};
						...
						new Thread((ThreadStart)delegate
						{
							try
							{
								string path = CS_0024_003C_003E8__locals0.class55_0.string_0 + "\\" + CS_0024_003C_003E8__locals0.class55_0.fClearBackup_0.list_0[CS_0024_003C_003E8__locals0.int_0];
								Directory.Delete(path, recursive: true);
								Interlocked.Increment(ref CS_0024_003C_003E8__locals0.class55_0.int_2);
								CS_0024_003C_003E8__locals0.class55_0.fClearBackup_0.method_2(string.Format(GClass29.smethod_0("Đang dọn dẹp backup {0}/{1}..."), CS_0024_003C_003E8__locals0.class55_0.int_2, CS_0024_003C_003E8__locals0.class55_0.fClearBackup_0.list_0.Count));
								Interlocked.Decrement(ref CS_0024_003C_003E8__locals0.class55_0.int_0);
							}
							catch
							{
							}
				...
				fClearBackup_0.Invoke((Action)delegate
				{
					...
					GClass38.smethod_0(GClass29.smethod_0("Đã dọn dẹp file backup xong!"));
				});
			}
			catch
			{
	...
	private sealed class Class56
	{
		...
		internal void method_0()
		{
			try
			{
				string path = class55_0.string_0 + "\\" + class55_0.fClearBackup_0.list_0[int_0];
				Directory.Delete(path, recursive: true);
				Interlocked.Increment(ref class55_0.int_2);
				class55_0.fClearBackup_0.method_2(string.Format(GClass29.smethod_0("Đang dọn dẹp backup {0}/{1}..."), class55_0.int_2, class55_0.fClearBackup_0.list_0.Count));
				Interlocked.Decrement(ref class55_0.int_0);
			}
			catch
			{
			}
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		method_2(string.Format(GClass29.smethod_0("Đang dọn dẹp backup {0}/{1}..."), 0, list_0.Count));
		int int_0 = 0;
		int int_1 = 20;
		int int_2 = 0;
		string string_0 = GClass37.smethod_0() + "\\backup";
		new Thread((ThreadStart)delegate
		{
			try
			{
				...
				while (num < list_0.Count)
				{
					if (int_0 < int_1)
					{
						...
						new Thread((ThreadStart)delegate
						{
							try
							{
								string path = string_0 + "\\" + list_0[int_3];
								Directory.Delete(path, recursive: true);
								Interlocked.Increment(ref int_2);
								method_2(string.Format(GClass29.smethod_0("Đang dọn dẹp backup {0}/{1}..."), int_2, list_0.Count));
	...
	private void fClearBackup_Load(object sender, EventArgs e)
	{
		new Thread((ThreadStart)delegate
		{
			try
			{
				List<string> list = Directory.GetDirectories(GClass37.smethod_0() + "\\backup").ToList();
				...
				if (list_0.Count > 0)
				{
					Invoke((Action)delegate
					{
						lblStatus.Text = string.Format(GClass29.smethod_0("Tìm thấy {0} file backup rác!"), list_0.Count) + "\r\n" + GClass29.smethod_0("Bạn có muốn dọn dẹp?");
						btnAdd.Visible = true;
				...
				else
				{
					...
					{
						Close();
						GClass38.smethod_0(GClass29.smethod_0("Không có file backup rác!"));
					});
				}
			}
			catch
