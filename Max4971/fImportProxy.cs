...
public class fImportProxy : Form
{
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		try
		{
			...
			for (int j = 0; j < fChange.fChange_0.dtgvAcc.Rows.Count; j++)
			{
				if (Convert.ToBoolean(fChange.fChange_0.method_26(j, "cChose")) && (!(fChange.fChange_0.method_26(j, "cProxy") != "") || !ckbKhongNhapTaiKhoanDaCo.Checked))
				{
					if (queue.Count == 0)
					{
						break;
					...
					fChange.fChange_0.method_27(j, "cProxy", object_);
				}
			}
