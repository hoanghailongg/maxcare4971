...
public class fHDTuongTacNewsfeed : Form
{
	...
	public fHDTuongTacNewsfeed(string string_3, int int_1 = 0, string string_4 = "")
	{
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDTuongTacNewsfeed").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTuongTacNewsfeed', 'Tương tác Newsfeed');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDTuongTacNewsfeed");
