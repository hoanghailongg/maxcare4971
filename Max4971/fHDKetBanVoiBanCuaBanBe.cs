...
public class fHDKetBanVoiBanCuaBanBe : Form
{
	...
	public fHDKetBanVoiBanCuaBanBe(string string_3, int int_1 = 0, string string_4 = "")
	{
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDKetBanVoiBanCuaBanBe").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanVoiBanCuaBanBe', 'Kết bạn với bạn của Bạn bè');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDKetBanVoiBanCuaBanBe");
	...
	private void InitializeComponent()
	{
		...
		this.nudTimesWarning.Location = new System.Drawing.Point(253, 220);
		...
		this.label9.Location = new System.Drawing.Point(299, 222);
		...
		this.btnAdd.Location = new System.Drawing.Point(86, 146);
