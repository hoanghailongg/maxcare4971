...
public class fHDChangeSoThich : Form
{
	...
	public fHDChangeSoThich(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		bool_0 = false;
		string_0 = string_3;
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDChangeSoThich").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDChangeSoThich', 'Thay đổi sở thích');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDChangeSoThich");
	...
	private void txtTuKhoa_TextChanged(object sender, EventArgs e)
	{
		try
		{
			...
			label2.Text = string.Format(GClass29.smethod_0("Danh sa\u0301ch từ khóa ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		base.ClientSize = new System.Drawing.Size(398, 552);
