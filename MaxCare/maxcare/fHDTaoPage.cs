...
public class fHDTaoPage : Form
{
	...
	private TextBox txtTenPage;

	private Label label8;

	public fHDTaoPage(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		bool_0 = false;
		string_0 = string_3;
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDTaoPage").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTaoPage', 'Tạo Page');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDTaoPage");
	...
	private void fHDTaoPage_Load(object sender, EventArgs e)
	{
		try
		{
			nudSoLuongFrom.Value = gclass17_0.method_2("nudSoLuongFrom", 2);
			nudSoLuongTo.Value = gclass17_0.method_2("nudSoLuongTo", 2);
			nudDelayFrom.Value = gclass17_0.method_2("nudDelayFrom", 3);
			nudDelayTo.Value = gclass17_0.method_2("nudDelayTo", 5);
			txtTenPage.Text = gclass17_0.method_0("txtTenPage");
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		if (text == "")
		{
			GClass14.smethod_20("Vui lo\u0300ng nhâ\u0323p tên ha\u0300nh đô\u0323ng!", 3);
			return;
		}
		...
		gClass.method_5("txtTenPage", txtTenPage.Text.Trim());
		...
		if (int_0 == 0)
		{
			if (MessageBox.Show("Ba\u0323n co\u0301 muô\u0301n thêm ha\u0300nh đô\u0323ng mơ\u0301i?", "Thông ba\u0301o", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
			{
				...
				{
					GClass14.smethod_20("Thêm thâ\u0301t ba\u0323i, vui lo\u0300ng thư\u0309 la\u0323i sau!", 2);
				}
			}
		}
		else if (MessageBox.Show("Ba\u0323n co\u0301 muô\u0301n câ\u0323p nhâ\u0323t ha\u0300nh đô\u0323ng?", "Thông ba\u0301o", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
		{
			...
			{
				GClass14.smethod_20("Câ\u0323p nhâ\u0323t thâ\u0301t ba\u0323i, vui lo\u0300ng thư\u0309 la\u0323i sau!", 2);
			}
		}
	}
	...
	{
		GClass14.smethod_70(txtUid, lblStatus);
	}
	...
	private void InitializeComponent()
	{
		...
		this.txtTenPage = new System.Windows.Forms.TextBox();
		...
		this.bunifuCustomLabel1.Size = new System.Drawing.Size(354, 31);
		this.bunifuCustomLabel1.TabIndex = 12;
		this.bunifuCustomLabel1.Text = "Cấu hình Tạo page";
		...
		this.pnlHeader.Size = new System.Drawing.Size(354, 31);
		...
		this.panel1.Controls.Add(this.txtTenPage);
		...
		this.lblStatus.Size = new System.Drawing.Size(179, 16);
		this.lblStatus.TabIndex = 0;
		this.lblStatus.Text = "Danh sa\u0301ch Uid nhận Page (0):";
		...
		this.btnAdd.Location = new System.Drawing.Point(78, 293);
		...
		this.bunifuCards1.Size = new System.Drawing.Size(354, 37);
		this.bunifuCards1.TabIndex = 28;
		this.txtUid.Location = new System.Drawing.Point(30, 182);
		this.txtUid.Name = "txtUid";
		this.txtUid.Size = new System.Drawing.Size(295, 98);
		this.txtUid.TabIndex = 47;
		this.txtUid.Text = "";
		...
		this.label8.Text = "Tên Page:";
		this.txtTenPage.Location = new System.Drawing.Point(132, 136);
		this.txtTenPage.Name = "txtTenPage";
		this.txtTenPage.Size = new System.Drawing.Size(194, 23);
		this.txtTenPage.TabIndex = 0;
		base.AutoScaleDimensions = new System.Drawing.SizeF(7f, 16f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(357, 337);
		...
		base.Load += new System.EventHandler(fHDTaoPage_Load);
