...
public class fHDCongKhaiBaiVietGanThe : Form
{
	...
	public fHDCongKhaiBaiVietGanThe(string string_3, int int_1 = 0, string string_4 = "")
	{
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDCongKhaiBaiVietGanThe").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDCongKhaiBaiVietGanThe', 'Công khai bài viết gắn thẻ');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDCongKhaiBaiVietGanThe");
