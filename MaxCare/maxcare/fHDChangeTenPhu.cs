...
public class fHDChangeTenPhu : Form
{
	...
	public fHDChangeTenPhu(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		bool_0 = false;
		string_0 = string_3;
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDChangeTenPhu").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDChangeTenPhu', 'Thay đổi tên phụ');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDChangeTenPhu");
	...
	private void fHDChangeTenPhu_Load(object sender, EventArgs e)
	{
		try
		{
			txtTenPhu.Text = gclass17_0.method_0("txtTenPhu");
		}
		catch
		{
		}
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		gClass.method_5("txtTenPhu", txtTenPhu.Text.Trim());
	...
	private void txtTenPhu_TextChanged(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtTenPhu.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			label2.Text = string.Format(GClass29.smethod_0("Danh sa\u0301ch tên phụ ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		this.panel1.Controls.Add(this.txtTenPhu);
		...
		this.panel1.Size = new System.Drawing.Size(398, 508);
		this.panel1.TabIndex = 0;
		this.panel1.Paint += new System.Windows.Forms.PaintEventHandler(panel1_Paint);
		this.txtTenPhu.Anchor = System.Windows.Forms.AnchorStyles.Bottom;
		this.txtTenPhu.Location = new System.Drawing.Point(30, 114);
		this.txtTenPhu.Name = "txtTenPhu";
		this.txtTenPhu.Size = new System.Drawing.Size(335, 320);
		...
		this.label10.Location = new System.Drawing.Point(27, 437);
		...
		this.btnCancel.Location = new System.Drawing.Point(206, 468);
		...
		this.btnAdd.Location = new System.Drawing.Point(99, 468);
		...
		base.ClientSize = new System.Drawing.Size(398, 508);
		...
		base.Load += new System.EventHandler(fHDChangeTenPhu_Load);
