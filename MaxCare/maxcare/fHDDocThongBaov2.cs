...
public class fHDDocThongBaov2 : Form
{
	...
	public fHDDocThongBaov2(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDDocThongBaov2").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDDocThongBaov2', 'Đọc thông báo v2');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDDocThongBaov2");
	...
	private void InitializeComponent()
	{
		...
		base.ClientSize = new System.Drawing.Size(362, 188);
		...
		base.Load += new System.EventHandler(fHDDocThongBaov2_Load);
