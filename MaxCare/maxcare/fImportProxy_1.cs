...
public class fImportProxy_1 : Form
{
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtProxy.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			List<string> list = new List<string>();
			if (list_.Count == 0)
			{
				GClass38.smethod_0(GClass29.smethod_0("Vui lo\u0300ng nhâ\u0323p thêm Proxy!"), 3);
				return;
			}
			...
			{
				if (Convert.ToBoolean(fMain.fMain_0.method_212(j, "cChose")) && (!(fMain.fMain_0.method_212(j, "cProxy") != "") || !ckbKhongNhapTaiKhoanDaCo.Checked))
				{
					if (queue.Count == 0)
					{
						break;
					...
					list2.Add(fMain.fMain_0.method_212(j, "cId") + "|" + text);
				}
			}
			if (Class36.smethod_6("proxy", list2))
			{
				queue = new Queue<string>(list);
				for (int k = 0; k < fMain.fMain_0.dtgvAcc.Rows.Count; k++)
				{
					if (Convert.ToBoolean(fMain.fMain_0.method_212(k, "cChose")) && (!(fMain.fMain_0.method_212(k, "cProxy") != "") || !ckbKhongNhapTaiKhoanDaCo.Checked))
					{
						if (queue.Count == 0)
						{
							break;
						...
						fMain.fMain_0.method_208(k, "cProxy", object_);
					}
				}
			}
	...
	private void txtProxy_TextChanged(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtProxy.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			lblStatus.Text = string.Format(GClass29.smethod_0("Danh sa\u0301ch Proxy ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(fImportProxy_1));
		...
		this.txtProxy.Font = new System.Drawing.Font("Tahoma", 9.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		...
		this.ckbKhongNhapTaiKhoanDaCo.Size = new System.Drawing.Size(284, 20);
