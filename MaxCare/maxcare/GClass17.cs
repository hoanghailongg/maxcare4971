...
public class GClass17
{
	[Serializable]
	[CompilerGenerated]
	private sealed class FB6D0A46
	{
		public static readonly FB6D0A46 _003C_003E9 = new FB6D0A46();
	...
	public GClass17(string string_1, bool bool_0 = false)
	{
		if (bool_0)
		{
			if (string_1.Trim() == "")
	...
	public int method_2(string string_1, int int_0 = 0)
	{
		...
		try
		{
			result = ((this.jobject_0[string_1] == null) ? int_0 : Convert.ToInt32(this.jobject_0[string_1].ToString()));
		}
		catch
		{
		}
