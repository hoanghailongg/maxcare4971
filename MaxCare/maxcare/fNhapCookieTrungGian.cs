...
public class fNhapCookieTrungGian : Form
{
	...
	{
		gclass17_0.method_5("cookie", txtCookie.Text);
		gclass17_0.method_8();
		bool_0 = true;
		Close();
	}
	...
	{
		txtCookie.Text = gclass17_0.method_0("cookie");
	}

	private void btnCheckLiveTokenTg_Click(object sender, EventArgs e)
	{
		if (Class32.smethod_2(txtCookie.Text, "", "", 0).StartsWith("1|"))
		{
			GClass38.smethod_0("Cookie live!");
		}
		else
		{
			GClass38.smethod_0("Cookie die!");
		}
	}
