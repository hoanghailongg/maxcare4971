...
public class fHDXemWatchv2 : Form
{
	...
	public fHDXemWatchv2(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDXemWatchv2").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDXemWatchv2', 'Xem watch v2');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDXemWatchv2");
	...
	private void fHDXemWatchv2_Load(object sender, EventArgs e)
	{
		try
		{
	...
	private void InitializeComponent()
	{
		...
		base.Load += new System.EventHandler(fHDXemWatchv2_Load);
