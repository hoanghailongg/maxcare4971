...
public class fHDTuongTacBaiVietTheoID : Form
{
	...
	public fHDTuongTacBaiVietTheoID(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDTuongTacBaiVietTheoID").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDTuongTacBaiVietTheoID', 'Tương tác bài viết theo ID');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDTuongTacBaiVietTheoID");
	...
	private void fHDTuongTacBaiVietTheoID_Load(object sender, EventArgs e)
	{
		try
		{
			...
			ckbTuDongXoa.Checked = gclass17_0.method_3("ckbTuDongXoa");
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		if (list_.Count == 0)
		{
			GClass38.smethod_0(GClass29.smethod_0("Vui lo\u0300ng nhâ\u0323p danh sa\u0301ch Id ba\u0300i viê\u0301t câ\u0300n tương tác!"), 3);
			return;
		}
		...
		gClass.method_5("ckbTuDongXoa", ckbTuDongXoa.Checked);
	...
	private void InitializeComponent()
	{
		...
		this.ckbTuDongXoa.Size = new System.Drawing.Size(212, 20);
