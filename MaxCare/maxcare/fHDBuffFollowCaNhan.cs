...
public class fHDBuffFollowCaNhan : Form
{
	...
	public fHDBuffFollowCaNhan(string string_3, int int_1 = 0, string string_4 = "")
	{
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDBuffFollowCaNhan").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"CauHinh\", \"MoTa\") VALUES ('HDBuffFollowCaNhan', '{  \"txtUid\": \"\",\"nudDelayFrom\": \"5\",  \"nudDelayTo\": \"10\"}', 'Buff Follow ca\u0301 nhân');");
		}
		string json = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDBuffFollowCaNhan");
	...
	private void txtUid_TextChanged(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtUid.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			label2.Text = string.Format(GClass29.smethod_0("Danh sa\u0301ch Uid Ca\u0301 nhân ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(fHDBuffFollowCaNhan));
		...
		this.bunifuCustomLabel1.Text = "Cấu hình Buff Follow ca\u0301 nhân";
		...
		this.panel1.Size = new System.Drawing.Size(362, 391);
		...
		this.txtUid.Location = new System.Drawing.Point(31, 125);
		...
		this.label2.Text = "Danh sa\u0301ch Uid Ca\u0301 nhân (0):";
		...
		this.btnAdd.Location = new System.Drawing.Point(81, 347);
		...
		base.ClientSize = new System.Drawing.Size(362, 391);
		...
		base.Load += new System.EventHandler(fHDBuffFollowCaNhan_Load);
