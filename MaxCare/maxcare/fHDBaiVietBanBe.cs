...
public class fHDBaiVietBanBe : Form
{
	...
	private CheckBox ckbRandomNangCao;
	...
	public fHDBaiVietBanBe(string string_3, int int_1 = 0, string string_4 = "")
	{
		...
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDBaiVietBanBe");
	...
	private void fHDBaiVietBanBe_Load(object sender, EventArgs e)
	{
		try
		{
			nudSoLuongBanBeFrom.Value = gclass17_0.method_2("nudSoLuongBanBeFrom", 3);
			nudSoLuongBanBeTo.Value = gclass17_0.method_2("nudSoLuongBanBeTo", 5);
			nudSoLuongBaiVietFrom.Value = gclass17_0.method_2("nudSoLuongBaiVietFrom", 3);
			...
			ckbRandomNangCao.Checked = gclass17_0.method_3("ckbRandomNangCao");
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		if (int_0 == 0)
		{
			...
			gClass.method_5("ckbRandomNangCao", ckbRandomNangCao.Checked);
			int num = 0;
		...
		else
		{
			...
			gClass2.method_5("nudSoLuongBanBeFrom", nudSoLuongBanBeFrom.Value);
			gClass2.method_5("nudSoLuongBanBeTo", nudSoLuongBanBeTo.Value);
			...
			gClass2.method_5("ckbRandomNangCao", ckbRandomNangCao.Checked);
			int num2 = 0;
			if (rbNganCachKyTu.Checked)
			{
				num2 = 1;
	...
	private void InitializeComponent()
	{
		...
		this.ckbRandomNangCao = new System.Windows.Forms.CheckBox();
		...
		this.panel1.Controls.Add(this.ckbRandomNangCao);
		...
		this.ckbRandomNangCao.AutoSize = true;
		this.ckbRandomNangCao.Cursor = System.Windows.Forms.Cursors.Hand;
		this.ckbRandomNangCao.Location = new System.Drawing.Point(207, 171);
		this.ckbRandomNangCao.Name = "ckbRandomNangCao";
		this.ckbRandomNangCao.Size = new System.Drawing.Size(129, 20);
		this.ckbRandomNangCao.TabIndex = 107;
		this.ckbRandomNangCao.Text = "Random nâng cao";
		this.ckbRandomNangCao.UseVisualStyleBackColor = true;
		...
		base.Load += new System.EventHandler(fHDBaiVietBanBe_Load);
