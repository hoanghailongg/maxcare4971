...
public class fHDThamGiaNhomUidv2 : Form
{
	...
	public fHDThamGiaNhomUidv2(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDThamGiaNhomUidv2").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDThamGiaNhomUidv2', 'Tham gia nhóm theo tệp UID v2');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDThamGiaNhomUidv2");
	...
	private void fHDThamGiaNhomUidv2_Load(object sender, EventArgs e)
	{
		try
		{
			...
			ckbTuDongXoaUid.Checked = gclass17_0.method_3("ckbThamGiaNhomTrungNhau");
			txtUid.Text = gclass17_0.method_0("txtUid");
			ckbTuDongTraLoiCauHoi.Checked = gclass17_0.method_3("ckbTuDongTraLoiCauHoi");
			ckbTuDongXoaUid.Checked = gclass17_0.method_3("ckbTuDongXoaUid");
			txtCauTraLoi.Text = gclass17_0.method_0("txtCauTraLoi");
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		this.bunifuCustomLabel1.Text = "Cấu hình Tham gia nhóm theo tệp UID v2";
