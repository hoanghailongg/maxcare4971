...
public class fHDChucMungSinhNhat : Form
{
	...
	public fHDChucMungSinhNhat(string string_3, int int_1 = 0, string string_4 = "")
	{
		...
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDChucMungSinhNhat");
	...
	private void method_0()
	{
		...
		GClass29.smethod_1(rbNhanTin);
		GClass29.smethod_1(rbDangBai);
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		List<string> list_ = txtContent.Lines.ToList();
		list_ = GClass14.smethod_36(list_);
		if (list_.Count == 0)
		{
			GClass38.smethod_0(GClass29.smethod_0("Vui lo\u0300ng nhâ\u0323p nô\u0323i dung tin nhă\u0301n/ba\u0300i viê\u0301t!"), 3);
			return;
		}
		...
		{
			gClass.method_5("typeAction", 0);
		}
		else
		{
			gClass.method_5("typeAction", 1);
		}
		gClass.method_5("txtContent", txtContent.Text.Trim());
	...
	private void txtContent_TextChanged(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtContent.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			lblStatus.Text = string.Format(GClass29.smethod_0("Danh sa\u0301ch tin nhă\u0301n/ba\u0300i viê\u0301t ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	{
		GClass38.smethod_0(GClass29.smethod_0("Có thể dùng [u] để thay thế tên của người nhận!"));
	}
	...
	private void InitializeComponent()
	{
		...
		this.rbDangBai.Size = new System.Drawing.Size(77, 20);
		...
		this.rbNhanTin.Size = new System.Drawing.Size(73, 20);
		...
		this.lblStatus.Size = new System.Drawing.Size(189, 16);
