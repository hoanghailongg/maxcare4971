...
public class fHDXemStoryChiDinh : Form
{
	...
	public fHDXemStoryChiDinh(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDXemStoryChiDinh").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDXemStoryChiDinh','Xem story chỉ định');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDXemStoryChiDinh");
	...
	private void fHDXemStoryChiDinh_Load(object sender, EventArgs e)
	{
		try
		{
			txtLinkStory.Text = gclass17_0.method_0("txtLinkStory");
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		gClass.method_5("txtLinkStory", txtLinkStory.Text);
	...
	private void txtLinkStory_TextChanged(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtLinkStory.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			label2.Text = string.Format(GClass29.smethod_0("Danh sách link ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		this.panel1.Size = new System.Drawing.Size(362, 266);
		...
		this.ckbInteract.Location = new System.Drawing.Point(30, 285);
		...
		this.txtLinkStory.TextChanged += new System.EventHandler(txtLinkStory_TextChanged);
		...
		base.Load += new System.EventHandler(fHDXemStoryChiDinh_Load);
