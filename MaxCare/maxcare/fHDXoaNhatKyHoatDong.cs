...
public class fHDXoaNhatKyHoatDong : Form
{
	...
	public fHDXoaNhatKyHoatDong(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		int_0 = int_1;
		string text = "";
		if (Class307.smethod_13("", "HDXoaNhatKyHoatDong").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDXoaNhatKyHoatDong', 'Xóa nhật ký hoạt động');");
		}
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDXoaNhatKyHoatDong");
	...
	private void fHDXoaNhatKyHoatDong_Load(object sender, EventArgs e)
	{
		try
		{
			nudSoLuong.Value = gclass17_0.method_2("nudSoLuong");
			nudDelayFrom.Value = gclass17_0.method_2("nudDelayFrom");
			nudDelayTo.Value = gclass17_0.method_2("nudDelayTo");
			ckbXoaThangNay.Checked = gclass17_0.method_3("ckbXoaThangNay");
		}
		catch
		{
		}
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		gClass.method_5("nudSoLuong", nudSoLuong.Value);
		gClass.method_5("nudDelayFrom", nudDelayFrom.Value);
		gClass.method_5("nudDelayTo", nudDelayTo.Value);
		gClass.method_5("ckbXoaThangNay", ckbXoaThangNay.Checked);
	...
	private void InitializeComponent()
	{
		...
		this.nudSoLuong.Location = new System.Drawing.Point(132, 81);
		this.nudSoLuong.Maximum = new decimal(new int[4] { 999999, 0, 0, 0 });
		this.nudSoLuong.Name = "nudSoLuong";
		this.nudSoLuong.Size = new System.Drawing.Size(56, 23);
		...
		base.Load += new System.EventHandler(fHDXoaNhatKyHoatDong_Load);
