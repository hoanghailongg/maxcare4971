...
public class fHDKetBanGoiYv2 : Form
{
	...
	public fHDKetBanGoiYv2(string string_3, int int_1 = 0, string string_4 = "")
	{
		InitializeComponent();
		method_0();
		bool_0 = false;
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDKetBanGoiYv2").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanGoiYv2', 'Kết bạn theo gợi ý v2');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDKetBanGoiYv2");
	...
	private void method_0()
	{
		...
		GClass29.smethod_1(ckbChiKetBanTenCoDau);
		GClass29.smethod_1(ckbOnlyAddFriendWithMutualFriends);
	...
	private void fHDKetBanGoiYv2_Load(object sender, EventArgs e)
	{
		try
		{
			...
			ckbChiKetBanTenCoDau.Checked = gclass17_0.method_3("ckbChiKetBanTenCoDau");
			ckbOnlyAddFriendWithMutualFriends.Checked = gclass17_0.method_3("ckbOnlyAddFriendWithMutualFriends");
			nudTimesWarning.Value = gclass17_0.method_2("nudTimesWarning", 3);
		}
		catch
		{
		}
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		gClass.method_5("ckbChiKetBanTenCoDau", ckbChiKetBanTenCoDau.Checked);
		gClass.method_5("ckbOnlyAddFriendWithMutualFriends", ckbOnlyAddFriendWithMutualFriends.Checked);
		gClass.method_5("nudTimesWarning", nudTimesWarning.Value);
	...
	private void InitializeComponent()
	{
		...
		this.bunifuCustomLabel1.Text = "Cấu hình Kết bạn gợi ý v2";
		...
		base.Load += new System.EventHandler(fHDKetBanGoiYv2_Load);
