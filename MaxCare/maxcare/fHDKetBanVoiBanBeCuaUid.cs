...
public class fHDKetBanVoiBanBeCuaUid : Form
{
	...
	public fHDKetBanVoiBanBeCuaUid(string string_3, int int_1 = 0, string string_4 = "")
	{
		...
		string_2 = string_4;
		int_0 = int_1;
		if (Class307.smethod_13("", "HDKetBanVoiBanBeCuaUid").Rows.Count == 0)
		{
			GClass32.GClass32_0.method_2("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanVoiBanBeCuaUid', 'Kết bạn với bạn bè của Uid');");
		}
		string text = "";
		switch (int_1)
		{
		case 0:
		{
			DataTable dataTable2 = Class307.smethod_13("", "HDKetBanVoiBanBeCuaUid");
	...
	private void btnAdd_Click(object sender, EventArgs e)
	{
		...
		if (list_.Count == 0)
		{
			GClass38.smethod_0(GClass29.smethod_0("Vui lo\u0300ng nhâ\u0323p danh sách uid!"), 3);
			return;
		}
	...
	private void txtUid_TextChanged(object sender, EventArgs e)
	{
		try
		{
			List<string> list_ = txtUid.Lines.ToList();
			list_ = GClass14.smethod_36(list_);
			lblStatus.Text = string.Format(GClass29.smethod_0("Danh sa\u0301ch Uid ({0}):"), list_.Count.ToString());
		}
		catch
		{
		}
	...
	private void InitializeComponent()
	{
		...
		this.panel1.Size = new System.Drawing.Size(362, 374);
